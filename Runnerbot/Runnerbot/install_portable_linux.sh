...
echo "============================================"
echo "  Runnerbot Portable Installer for Linux"
echo "============================================"
echo
...
read -p "Enter installation path (e.g., /media/usb/Runnerbot): " INSTALL_PATH
...
if command -v python3 &> /dev/null; then
    ...
    echo "Python 3 not found. Run install_linux.sh on target system."
fi
